...
interface HiraganaMixerPlayerProps {
  content: {
...
const HiraganaMixerPlayer = ({ content }: HiraganaMixerPlayerProps) => {
...
export default HiraganaMixerPlayer;
