...
export default function CreateJapList1000() {
  ...
  const createPath = async () => {
    ...
    try {
      ...
      const pathId = 'path-jap-list-1000-words';
  ...
  return (
    <div className="container mx-auto p-8 max-w-3xl">
      <h1 className="text-3xl font-bold mb-6">Créer le parcours JAP LIST 1000 WORDS</h1>
      ...
      {!created ? (
        ...
        <Card className="p-6 bg-green-50 border-green-200">
          ...
          <p className="text-gray-700 mb-6">
            Le parcours "JAP LIST 1000 WORDS" a été créé avec 10 chapitres et 40 sous-chapitres.
          </p>
