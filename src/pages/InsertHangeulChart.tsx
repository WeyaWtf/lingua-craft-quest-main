...
const InsertHangeulChart = () => {
  ...
  useEffect(() => {
    const insertExercise = async () => {
      ...
      const exerciseData = {
        type: "flashcard",
        title: "Hangeul Chart - Tableau de l'alphabet coréen",
        description: "Apprenez l'alphabet coréen (Hangeul) avec ses 14 consonnes de base, 5 consonnes complexes, 10 voyelles de base et 11 voyelles complexes - Cliquez sur chaque caractère pour révéler sa romanisation",
        difficulty: 1,
        source: "official",
        language: "korean",
        tags: ["alphabet", "hangeul", "korean", "consonants", "vowels", "chart"],
...
export default InsertHangeulChart;
