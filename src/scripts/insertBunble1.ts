// Script pour insérer l'exercice Bunble 1 dans Supabase
// À utiliser via la console du navigateur ou un composant temporaire

import { supabase } from '@/lib/supabase';

export const insertBunble1 = async () => {
  const bunble1Cards = [
  ...
  try {
    ...
    console.log('✅ Exercice Bunble 1 créé avec succès!', data);
...
// import { insertBunble1 } from './src/scripts/insertBunble1'
// insertBunble1().then(console.log)
